...
public class RoleController {
    ...
    * Controller for adding new Role.
    ...
    private void addAdminRole(HttpServletRequest request,@RequestBody AdminRoles role){
        logger.info("adminRoles API Called");
        String employeeId = null;
        try {
            logger.info("Trying to Fetch the Employee Id from the HTTP HEADERS");
    ...
    public void deleteRole(HttpServletRequest request,@RequestParam String id){
        logger.info("adminRoles API Called");
        String employeeId = null;
        try {
            logger.info("Trying to Fetch the Employee Id from the HTTP HEADERS");
