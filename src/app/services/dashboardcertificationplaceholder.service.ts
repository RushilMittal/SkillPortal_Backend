...
export class DashboardCertificationPlaceholderService {
  ...
  getCertificatePlaceholder(employeeId: string): Observable<EmployeeCertificatePlaceholderModel> {
    // console.log('inside GetCertificatePlaceholder');
    const url = `${this.apiRoot}/getcertificationplaceholder?employeeId=${employeeId}`;
    // console.log(url);
