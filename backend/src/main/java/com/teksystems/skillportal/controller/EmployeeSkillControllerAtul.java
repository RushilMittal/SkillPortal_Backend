...
import com.teksystems.skillportal.service.EmployeeSkillServiceAtul;
...
@CrossOrigin("*")
public class EmployeeSkillControllerAtul{

	private static Logger logger = Logger.getLogger(EmployeeSkillController.class);

	@Autowired
	 private EmployeeSkillServiceAtul employeeSkillServiceAtul;

//	@GetMapping("/getSubSkillsBySkill")
//	public List<SubSkill> getBySkillIdExcept(@RequestParam String empId, @RequestParam String skillId) throws ExecutionException {
...
//		return employeeSkillServiceAtul.getAllUnassignedSubSkills(empId, skillId);
//	}
